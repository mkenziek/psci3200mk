...
pan_pri_close_elections %>%
  filter(post_election_avg_rate < 20) %>%
...
ggplot() +
  ...
  geom_point(data = average_homicide_rate, 
             aes(x = x, y = mean_rate), 
             alpha = 0.5) +
  labs(title = "Post-Election Municipal Homicide Rates in Mexico RD Figure (2001-2020)",
       x = "PAN Margin of Victory",
       y = "Post-Election Homicide Rate per 100,000 Residents",
       caption = "Each point represents the average value of the homicide rate in vote spread bins of width one-half of a percentage point.") +
  theme_classic()
